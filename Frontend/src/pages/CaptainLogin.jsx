...
const CaptainLogin = () => {
  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between'>
      ...
      <div>
        <Link to='/login' className='bg-[#10b461] flex items-center justify-center mb-5 text-white rounded px-4 py-2 w-full text-lg placeholder:text-base'>Sign in as User</Link>
      </div>
    </div>
  )
}
